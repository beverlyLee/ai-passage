...
`01` 计费模拟实跑（加载 o3 计价参数，同题，输入 1200 token）：
...
两条 self-test 全绿，模拟数字与正文引用一致。脚本不连任何外部服务，假后端确定性可复现。
...
| 图 3 | `diagram/think-tokens/03-billing@2x.png` | 同题不同 effort 的计费对比（o3 计价参数模拟） |
