...
SVG_DIR = "/Users/liboyang/WorkBuddy/2026-08-14-17-18-24/ai-passage/2026-09-13-全民效率悖论/diagram/全民效率悖论"

# 顺序 == 阅读顺序 == 图注号 == 配图 CDN 清单（四同步）
SVGS = [
    "01-waitangi-question.svg",
    "02-expectation-reality-gap.svg",
    "03-verification-tax-brainfry.svg",
    "04-cognitive-load-explosion.svg",
    "05-bottleneck-shift.svg",
    "06-nine-pitfalls-layered.svg",
]
