#!/usr/bin/env python3
"""Render diagram/looped/*.svg -> *.@2x.png (1360x900) via Chrome headless.
Same pipeline as diagram/rag & diagram/skills."""
import subprocess, os, glob, struct

CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
SVG_DIR = "/Users/liboyang/WorkBuddy/2026-08-14-17-18-24/diagram/looped"
